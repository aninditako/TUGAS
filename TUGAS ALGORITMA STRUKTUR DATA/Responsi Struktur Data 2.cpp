...
typedef struct typesouvenirdimeja *typeptrsouvenir;      //typesmeja typeptrs
...
int menu()
{
    int pilih;
    	...
    	cout<<"|----------------------------------------------------|\n";
		cout<<"|         Sisa orang yang boleh masuk    =  "<<slot<<"        |\n";                          //slot=sisa
		cout<<"|         Tumpukan Souvenir              =  "<<souvenir_meja<<"        |\n";                 //souvenir_meja=smeja
		cout<<"|----------------------------------------------------|\n";
...
void masuk()
{
   if(souvenir_meja > 0)
   {
        ...
        do
		{
            ...
            if(input->jumlah_orang < 1 || input->jumlah_orang > 2) cout << "   *** Undangan hanya berlaku untuk maksimal 2 orang ***" << endl;
...
void souvenir(){
	...
	cout<<"   +----------------------------------------------------|\n";
	cout<<"\t 1. Push\n";
	cout<<"\t 2. Lihat Tumpukan Souvenir\n";
	cout<<"\tPilih : ";cin>>confirm;
    if(tolower(confirm) == '1') {
        if(kardus_kosong()){
            push();
        }
