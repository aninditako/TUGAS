...
void push(barang IB);
void cetakStack();
void popPilih(char kodepcari[10]);
...
//====================================================================== B A R A N G =======================================================================
//hapus barang masih per jenis pakaian, harusnya bebas jenis apa dan banyaknya berapa
...
void menu2()
{
	...
	//					menuStack();
					...
					case 3:
						...
						cin.ignore();
						cout<<"\t Kode Pakaian : ";
				        cin.getline(caripakaian,sizeof(caripakaian));
				        popPilih(caripakaian);
					break;
...
//melayani customer 1 per satu sesuai kapasitas atau masuk ke queue semua dahulu?? KAYAK RESPONSI
...
void inputAntrian()
{
	...
	cout<<"         Banyak Antrian : "; cin>>banyak;
		...
		for(int j=0; j<banyak; j++)
		{
			...
			cout<<"\t   Banyak Jenis Pakaian yang akan dibeli : "; cin>>banyakP;
			for(int i=0; i<banyakP; i++)
			{
...
void cetakAntrian()
{
	...
	if (queuekosong())
 	...
 	{	
		...
		do 
		{ 			
			cout<<"         Customer ke-"<<j+1<<endl;                                       //yang kecetak cust1 pakaian terakhir KALAU > 1 PAKAIAN SALAH
			cout<<"\t   Nama Customer      : "<<bantu->data.cus<<endl;
			for(int i=0; i<banyakP; i++)
			{
				cout<<"\t   Kode Pakaian ke-"<<i+1<<"  : "<<bantu2->data.kodeO<<endl; 
				cout<<"\t   Jumlah Order       : "<<bantu2->data.jumlah<<endl;
				bantu2=bantu2->next;	
				i++;					
			}
...
void layani()
{
	...
	bantu2=depan;
		...
		do 
			{
				cout<<"\t   Kode Pakaian ke-"<<i+1<<"  : "<<bantu2->data.kodeO<<endl; //kode pakaian ketuker, banyak pakaian pake yang terakhir diinput
				cout<<"\t   Jumlah Order       : "<<bantu2->data.jumlah<<endl;
				bantu2=bantu2->next;	
				i++;					
			}while(bantu2!=NULL);
